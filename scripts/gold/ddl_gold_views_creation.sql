...
-- We need to use the dimension surrogate keys instead of IDs to easily connect the Facts with Dimensions.
-- =============================================================================
...
CREATE VIEW gold.fact_sales AS
	SELECT 
		...
		dp.product_key, -- dimension surrogate keys
		cus.customer_key, -- dimension surrogate keys
...
-- ===========================================================
-- Foreign Key Integrity - Dimensions fast test.
-- ===========================================================
